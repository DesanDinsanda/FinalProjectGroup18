...
<br><br><br><br><br>
    ...
    <div class="container text-center my-5">
        <h1 class="fw-bold">Our Ongoing Wedding Packages</h1>
        <h6 class="mt-3">
            Select your package and celebrate your wedding. We can customize anything if you want.
            All are including best service and with well-planned budget.
        </h6>

        <h2 class="mt-4">Want a Custom Package?</h2>
        <button type="button" class="custom-btn mt-3" onclick="window.location.href='fetchCartWeddingPackageItems.php'">
            Create Custom Package
        </button>
    </div>
    
    <div class="card-container">
        <?php include 'fetchWeddingDetails.php'; ?>
    </div>
